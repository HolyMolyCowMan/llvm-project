...
; CHECK:         smaxv.8b b0, v0
; CHECK-NEXT:    smov.b w0, v0[0]
; CHECK-NEXT:    ret
entry:
...
; CHECK:         smaxv.4h h0, v0
; CHECK-NEXT:    smov.h w0, v0[0]
; CHECK-NEXT:    ret
entry:
