...
; CHECK-GI-NEXT:    bfi w9, w11, #1, #31
; CHECK-GI-NEXT:    umov.b w13, v1[1]
; CHECK-GI-NEXT:    umov.b w15, v1[0]
; CHECK-GI-NEXT:    and w10, w10, #0x1
; CHECK-GI-NEXT:    umov.b w11, v0[4]
; CHECK-GI-NEXT:    and w8, w8, #0x1
; CHECK-GI-NEXT:    orr w9, w9, w12, lsl #2
; CHECK-GI-NEXT:    umov.b w12, v0[2]
; CHECK-GI-NEXT:    bfi w14, w8, #1, #31
; CHECK-GI-NEXT:    umov.b w8, v1[3]
; CHECK-GI-NEXT:    and w17, w17, #0x1
; CHECK-GI-NEXT:    and w16, w16, #0x1
; CHECK-GI-NEXT:    orr w9, w9, w10, lsl #3
; CHECK-GI-NEXT:    umov.b w10, v1[2]
; CHECK-GI-NEXT:    and w13, w13, #0x1
; CHECK-GI-NEXT:    bfi w15, w13, #1, #31
; CHECK-GI-NEXT:    and w11, w11, #0x1
; CHECK-GI-NEXT:    umov.b w13, v0[6]
; CHECK-GI-NEXT:    and w12, w12, #0x1
; CHECK-GI-NEXT:    orr w9, w9, w11, lsl #4
; CHECK-GI-NEXT:    umov.b w11, v0[7]
; CHECK-GI-NEXT:    orr w12, w14, w12, lsl #2
; CHECK-GI-NEXT:    umov.b w14, v1[4]
; CHECK-GI-NEXT:    and w8, w8, #0x1
; CHECK-GI-NEXT:    and w10, w10, #0x1
; CHECK-GI-NEXT:    orr w9, w9, w17, lsl #5
; CHECK-GI-NEXT:    umov.b w17, v0[5]
; CHECK-GI-NEXT:    orr w10, w15, w10, lsl #2
; CHECK-GI-NEXT:    and w13, w13, #0x1
; CHECK-GI-NEXT:    umov.b w15, v0[4]
; CHECK-GI-NEXT:    orr w9, w9, w13, lsl #6
; CHECK-GI-NEXT:    and w11, w11, #0x1
; CHECK-GI-NEXT:    umov.b w13, v1[6]
; CHECK-GI-NEXT:    orr w8, w10, w8, lsl #3
; CHECK-GI-NEXT:    umov.b w10, v1[5]
; CHECK-GI-NEXT:    and w14, w14, #0x1
; CHECK-GI-NEXT:    orr w9, w9, w11, lsl #7
; CHECK-GI-NEXT:    orr w12, w12, w16, lsl #3
; CHECK-GI-NEXT:    umov.b w16, v1[7]
; CHECK-GI-NEXT:    orr w8, w8, w14, lsl #4
; CHECK-GI-NEXT:    umov.b w11, v0[0]
; CHECK-GI-NEXT:    umov.b w14, v0[6]
; CHECK-GI-NEXT:    strb w9, [sp, #8]
; CHECK-GI-NEXT:    umov.b w9, v0[2]
; CHECK-GI-NEXT:    and w15, w15, #0x1
; CHECK-GI-NEXT:    and w10, w10, #0x1
; CHECK-GI-NEXT:    and w13, w13, #0x1
; CHECK-GI-NEXT:    orr w12, w12, w15, lsl #4
...
; CHECK-GI-NEXT:    umov.b w13, v0[7]
; CHECK-GI-NEXT:    umov.b w15, v0[3]
; CHECK-GI-NEXT:    orr w12, w12, w17, lsl #5
; CHECK-GI-NEXT:    and w9, w9, #0x1
; CHECK-GI-NEXT:    umov.b w17, v0[2]
; CHECK-GI-NEXT:    and w10, w10, #0x1
; CHECK-GI-NEXT:    orr w8, w8, w16, lsl #7
; CHECK-GI-NEXT:    umov.b w16, v0[2]
; CHECK-GI-NEXT:    bfi w11, w10, #1, #31
; CHECK-GI-NEXT:    and w10, w14, #0x1
; CHECK-GI-NEXT:    umov.b w14, v0[4]
; CHECK-GI-NEXT:    strb w8, [sp, #9]
; CHECK-GI-NEXT:    orr w8, w12, w10, lsl #6
; CHECK-GI-NEXT:    and w10, w13, #0x1
; CHECK-GI-NEXT:    orr w9, w11, w9, lsl #2
...
; CHECK-GI-NEXT:    and w9, w10, #0x1
; CHECK-GI-NEXT:    umov.b w10, v0[3]
; CHECK-GI-NEXT:    bfi w14, w9, #1, #31
; CHECK-GI-NEXT:    umov.b w9, v0[4]
; CHECK-GI-NEXT:    orr w8, w8, w13, lsl #6
; CHECK-GI-NEXT:    and w11, w11, #0x1
...
; CHECK-GI-NEXT:    orr w10, w11, w10, lsl #3
; CHECK-GI-NEXT:    and w9, w9, #0x1
; CHECK-GI-NEXT:    umov.b w11, v0[6]
; CHECK-GI-NEXT:    and w12, w13, #0x1
; CHECK-GI-NEXT:    umov.b w13, v0[3]
; CHECK-GI-NEXT:    strb w8, [sp, #11]
; CHECK-GI-NEXT:    orr w9, w10, w9, lsl #4
; CHECK-GI-NEXT:    umov.b w10, v0[7]
; CHECK-GI-NEXT:    bfi w14, w12, #1, #31
; CHECK-GI-NEXT:    and w12, w15, #0x1
; CHECK-GI-NEXT:    and w15, w16, #0x1
; CHECK-GI-NEXT:    umov.b w16, v0[4]
; CHECK-GI-NEXT:    orr w8, w9, w12, lsl #5
; CHECK-GI-NEXT:    orr w9, w14, w15, lsl #2
; CHECK-GI-NEXT:    and w11, w11, #0x1
; CHECK-GI-NEXT:    and w12, w13, #0x1
; CHECK-GI-NEXT:    umov.b w13, v0[5]
; CHECK-GI-NEXT:    umov.b w14, v0[1]
; CHECK-GI-NEXT:    orr w8, w8, w11, lsl #6
; CHECK-GI-NEXT:    and w10, w10, #0x1
...
; CHECK-GI-NEXT:    umov.b w16, v0[0]
; CHECK-GI-NEXT:    orr w9, w9, w11, lsl #5
; CHECK-GI-NEXT:    umov.b w11, v0[3]
; CHECK-GI-NEXT:    and w14, w14, #0x1
; CHECK-GI-NEXT:    and w12, w12, #0x1
; CHECK-GI-NEXT:    strb w8, [sp, #12]
; CHECK-GI-NEXT:    bfi w10, w14, #1, #31
; CHECK-GI-NEXT:    orr w9, w9, w12, lsl #6
; CHECK-GI-NEXT:    umov.b w12, v0[4]
; CHECK-GI-NEXT:    and w13, w13, #0x1
; CHECK-GI-NEXT:    and w14, w15, #0x1
; CHECK-GI-NEXT:    umov.b w15, v0[3]
; CHECK-GI-NEXT:    orr w10, w10, w13, lsl #2
; CHECK-GI-NEXT:    and w11, w11, #0x1
; CHECK-GI-NEXT:    bfi w16, w14, #1, #31
; CHECK-GI-NEXT:    umov.b w13, v0[5]
; CHECK-GI-NEXT:    and w14, w17, #0x1
; CHECK-GI-NEXT:    umov.b w17, v0[4]
; CHECK-GI-NEXT:    orr w10, w10, w11, lsl #3
; CHECK-GI-NEXT:    and w11, w12, #0x1
; CHECK-GI-NEXT:    orr w12, w16, w14, lsl #2
; CHECK-GI-NEXT:    umov.b w14, v0[6]
; CHECK-GI-NEXT:    and w15, w15, #0x1
; CHECK-GI-NEXT:    umov.b w16, v0[5]
; CHECK-GI-NEXT:    orr w10, w10, w11, lsl #4
; CHECK-GI-NEXT:    orr w12, w12, w15, lsl #3
; CHECK-GI-NEXT:    umov.b w11, v0[7]
; CHECK-GI-NEXT:    and w13, w13, #0x1
; CHECK-GI-NEXT:    and w15, w17, #0x1
; CHECK-GI-NEXT:    umov.b w17, v0[6]
; CHECK-GI-NEXT:    orr w10, w10, w13, lsl #5
; CHECK-GI-NEXT:    umov.b w13, v0[7]
; CHECK-GI-NEXT:    orr w12, w12, w15, lsl #4
; CHECK-GI-NEXT:    and w14, w14, #0x1
; CHECK-GI-NEXT:    and w15, w16, #0x1
; CHECK-GI-NEXT:    umov.b w16, v0[7]
; CHECK-GI-NEXT:    orr w10, w10, w14, lsl #6
; CHECK-GI-NEXT:    fmov w14, s1
; CHECK-GI-NEXT:    orr w12, w12, w15, lsl #5
; CHECK-GI-NEXT:    and w11, w11, #0x1
; CHECK-GI-NEXT:    orr w9, w9, w11, lsl #7
; CHECK-GI-NEXT:    mov.s v0[1], w14
; CHECK-GI-NEXT:    and w14, w17, #0x1
; CHECK-GI-NEXT:    orr w11, w12, w14, lsl #6
; CHECK-GI-NEXT:    and w12, w13, #0x1
