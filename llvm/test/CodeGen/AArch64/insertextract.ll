...
; CHECK-SD-LABEL: insert_v2i128_0:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    adds x2, x2, x2
; CHECK-SD-NEXT:    mov x1, x5
; CHECK-SD-NEXT:    mov x0, x4
; CHECK-SD-NEXT:    adc x3, x3, x3
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: insert_v2i128_0:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    adds x2, x2, x2
; CHECK-GI-NEXT:    mov x0, x4
; CHECK-GI-NEXT:    mov x1, x5
; CHECK-GI-NEXT:    adc x3, x3, x3
; CHECK-GI-NEXT:    ret
entry:
  %aa = add <2 x i128> %a, %a
...
; CHECK-SD-LABEL: insert_v2i128_1:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    adds x0, x0, x0
; CHECK-SD-NEXT:    mov x3, x5
; CHECK-SD-NEXT:    mov x2, x4
; CHECK-SD-NEXT:    adc x1, x1, x1
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: insert_v2i128_1:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    adds x0, x0, x0
; CHECK-GI-NEXT:    mov x2, x4
; CHECK-GI-NEXT:    mov x3, x5
; CHECK-GI-NEXT:    adc x1, x1, x1
; CHECK-GI-NEXT:    ret
entry:
  %aa = add <2 x i128> %a, %a
...
; CHECK-SD-LABEL: insert_v2i128_c:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    sub sp, sp, #32
; CHECK-SD-NEXT:    .cfi_def_cfa_offset 32
; CHECK-SD-NEXT:    // kill: def $w6 killed $w6 def $x6
; CHECK-SD-NEXT:    adds x8, x0, x0
; CHECK-SD-NEXT:    and x11, x6, #0x1
; CHECK-SD-NEXT:    mov x12, sp
; CHECK-SD-NEXT:    adc x9, x1, x1
; CHECK-SD-NEXT:    adds x10, x2, x2
; CHECK-SD-NEXT:    add x11, x12, x11, lsl #4
; CHECK-SD-NEXT:    str x8, [sp]
; CHECK-SD-NEXT:    adc x8, x3, x3
; CHECK-SD-NEXT:    str x10, [sp, #16]
; CHECK-SD-NEXT:    str x4, [x11]
; CHECK-SD-NEXT:    str x8, [sp, #24]
; CHECK-SD-NEXT:    str x9, [sp, #8]
; CHECK-SD-NEXT:    str x5, [x11, #8]
; CHECK-SD-NEXT:    ldp x0, x1, [sp]
; CHECK-SD-NEXT:    ldp x2, x3, [sp, #16]
; CHECK-SD-NEXT:    add sp, sp, #32
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: insert_v2i128_c:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    stp x29, x30, [sp, #-16]! // 16-byte Folded Spill
; CHECK-GI-NEXT:    sub x9, sp, #48
; CHECK-GI-NEXT:    mov x29, sp
...
; CHECK-SD-LABEL: insert_v2fp128_0:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    sub sp, sp, #32
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: insert_v2fp128_0:
; CHECK-GI:       // %bb.0: // %entry
...
; CHECK-SD-LABEL: insert_v2fp128_1:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    sub sp, sp, #32
; CHECK-SD-NEXT:    str x30, [sp, #16] // 8-byte Spill
; CHECK-SD-NEXT:    .cfi_def_cfa_offset 32
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: insert_v2fp128_1:
; CHECK-GI:       // %bb.0: // %entry
...
; CHECK-SD-LABEL: insert_v2fp128_c:
; CHECK-SD:       // %bb.0: // %entry
...
; CHECK-GI-NEXT:    str q0, [x9, x8, lsl #4]
; CHECK-GI-NEXT:    ldp q0, q1, [sp, #64]
; CHECK-GI-NEXT:    mov sp, x29
; CHECK-GI-NEXT:    ldr x19, [sp, #16] // 8-byte Reload
...
; CHECK-SD-LABEL: extract_v2i128_c:
; CHECK-SD:       // %bb.0: // %entry
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: extract_v2i128_c:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    stp x29, x30, [sp, #-16]! // 16-byte Folded Spill
; CHECK-GI-NEXT:    sub x9, sp, #48
; CHECK-GI-NEXT:    mov x29, sp
...
; CHECK-SD-LABEL: extract_v2fp128_c:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    stp q0, q1, [sp, #-32]!
; CHECK-SD-NEXT:    .cfi_def_cfa_offset 32
; CHECK-SD-NEXT:    // kill: def $w0 killed $w0 def $x0
; CHECK-SD-NEXT:    and x8, x0, #0x1
; CHECK-SD-NEXT:    mov x9, sp
; CHECK-SD-NEXT:    ldr q0, [x9, x8, lsl #4]
; CHECK-SD-NEXT:    add sp, sp, #32
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: extract_v2fp128_c:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    stp x29, x30, [sp, #-16]! // 16-byte Folded Spill
; CHECK-GI-NEXT:    sub x9, sp, #48
; CHECK-GI-NEXT:    mov x29, sp
